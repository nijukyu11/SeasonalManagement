...
drop function if exists public.normalize_seasonal_import_time_v3(jsonb) cascade;
...
-- Public continuous-date traffic report v1. Keep mirrored with migration 20260822090000.
create schema if not exists reporting;
