...
create index if not exists season_entity_versions_target_idx on public.season_entity_versions (target_type, target_id);
...
begin
  ...
  loop
    ...
    if has_conflict then
      ...
      on conflict (client_id, op_id) do update set season_id = excluded.season_id, op_payload = excluded.op_payload
