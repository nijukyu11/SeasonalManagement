...
assert.match(dashboardRunner, /select_public_dashboard_correction_candidate_v1/);
...
assert.match(dashboardRunner, /for delay in 2m 5m 15m/);
assert.match(dashboardRunner, /acknowledge_public_dashboard_corrections_v1/);
assert.match(dashboardRunner, /defer_public_dashboard_correction_v1/);
